...
double drift_integ(double a, void *param)
{
  ...
  h = All.Omega0 / (a * a * a) + (1 - All.Omega0 - All.OmegaLambda) / (a * a) + All.OmegaLambda * de_factor(a,All.DEParamChoice);
  h = All.Hubble * sqrt(h);
...
double growthfactor_integ(double a, void *param)
{
  ...
  s = All.Omega0 + (1 - All.Omega0 - All.OmegaLambda) * a + All.OmegaLambda * de_factor(a,All.DEParamChoice) * a * a * a;
  s = sqrt(s);
