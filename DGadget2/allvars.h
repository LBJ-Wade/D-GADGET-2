...
extern struct global_data_all_processes
{
  ...
  double HubbleParam;  /*!< little `h', i.e. Hubble constant in units of 100 km/s/Mpc.  Only needed to get absolute physical values for cooling physics */
	double CurDEParam;	 /*!< current equation-of-state parameter for dark energy, w_0 in the DE EoS parameterization */
	double DEParamCoeff; /*!< w_a in the DE EoS parameterization, effectively dw/dz.  */
	int DEParamChoice;   /*!< Choice of DE EoS parameterization */
